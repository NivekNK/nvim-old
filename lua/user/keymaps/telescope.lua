...
if not status_ok then
    vim.notify("Error loading telescope.builtin on telescope keymaps!")
    return nil
end
...
function M.setup()
    ...
    K.nmap("<C-f>", "<cmd>Telescope live_grep<CR>")

end

function M.get_insert(actions)
    local i = {
